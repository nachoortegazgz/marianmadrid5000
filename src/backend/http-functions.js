...
serviceId: s.idServicio || s.serviceId || s._id,
tituloServicio: s.tituloServicio || s.title || "",
slugUrl: s.slugUrl || "",
precio: Number(s.precio || 0),
duracionTotal: Number(s.duracionTotal || 0),
permitirCombinar: s.permitirCombinar === true,
linkFases: _safeTrim(s.linkFases || s.idServicioFaseDos || ""),
}));
