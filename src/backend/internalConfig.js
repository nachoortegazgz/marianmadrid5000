...
VERSION: v5001-fixed-config
RESPONSIBILITY: Single Source of Truth for all backend configuration.
STANDARDS: G10 ASCII Strict (0 non-ASCII characters).
FIX: Removed all trailing spaces from COLLECTIONS values, SDK_CONFIG.TZ,
LOCATION_ID, LOCATION_TYPES, SERVICE_CATALOG values.
FIX: Corrected broken key names with embedded spaces:
RATE_LIMIT_CACHE_CLEANUP_TTL_MS, HEALTH_CHECK_QUERY_LIMIT,
AVAILABILITY_WINDOW_MS, DELETE_BATCH_SIZE,
BOOKINGS_SERVICE_SYNC_MAX_ATTEMPTS, BOOKINGS_SERVICE_SYNC_BACKOFF_MS.
*/
export const STAFF = Object.freeze({
IDS: [],
});
export const COLLECTIONS = Object.freeze({
SERVICIOS_RESERVA: "SERVICIOS_CATALOGO",
/** @deprecated Usar COLLECTIONS.SERVICIOS_RESERVA */
SERVICIOS_CITA: "SERVICIOS_CATALOGO",
ADDONS_CATALOGO: "COMPLEMENTOS_CATALOGO",
/** @deprecated Usar COLLECTIONS.ADDONS_CATALOGO */
EXTRAS_CATALOGO: "COMPLEMENTOS_CATALOGO",
/** @deprecated Usar COLLECTIONS.ADDONS_CATALOGO */
SERVICIOS_OPCIONES_ADDON: "COMPLEMENTOS_CATALOGO",
MAPA_STAFF: "MAPA_STAFF",
CATEGORIAS_SERVICIO: "CATEGORIAS_SERVICIO",
LOCALIZACIONES_SALON: "LOCALIZACIONES_SALON",
INVENTARIO_PRODUCTO: "INVENTARIO_STOCK_VENTA",
/** @deprecated Usar COLLECTIONS.INVENTARIO_PRODUCTO */
INVENTARIO_PRODUCTOS: "INVENTARIO_STOCK_VENTA",
PRODUCTOS_VENTA: "INVENTARIO_STOCK_VENTA",
MOVIMIENTO_INVENTARIO: "MOVIMIENTOS_INVENTARIO",
CONCILIACION_STOCK_WIX: "MOVIMIENTOS_INVENTARIO",
PROVEEDORES_INVENTARIO: "PROVEEDORES_LISTA",
DUAL_CACHE: "DUAL_SLOT_CACHE",
DAYS_CACHE: "AVAILABILITY_DAYS_CACHE",
SLOTS_CACHE: "DUAL_SLOT_CACHE",
CITAS: "CitasF2",
TRANSACTIONS: "BOOKING_TRANSACTIONS",
LOCKS: "SlotLocks",
COMPENSATIONS: "COMPENSACIONES_PENDIENTES",
MOVIMIENTOS_CAJA: "MOVIMIENTOS_CAJA",
CAJA_ACTUAL: "CAJA_ACTUAL",
HISTORICO_CIERRES_Z: "CIERRES_Z",
CONTEOS_X: "CONTROL_PARCIAL_X",
CONTADORES_FISCALES: "SECUENCIA_TICKETS",
REGISTRO_HORARIO: "REGISTROS_HORARIOS_STAFF",
AUDIT_LOG: "AUDITORIA",
SYNC_LOG: "M365_GRAPH_SYNC_QUEUE",
BOOKINGS_SERVICE_SYNC_QUEUE: "BOOKING_TRANSACTIONS",
BOOKINGS_SERVICE_SYNC_QUEUE_UPPER: "BOOKING_TRANSACTIONS",
M365_GRAPH_SYNC_QUEUE: "M365_GRAPH_SYNC_QUEUE",
...
LIBRO_INVENTARIO_CIERRE: "INVENTARIO_STOCK_VENTA_CIERRE",
