...
var CliUserErrorCode = (0, import_variant.variant)({
  ...
  FailedToRunExternalCommand: (0, import_variant.fields)(),
  ...
  HeadlessArgumentIsInvalid: (0, import_variant.fields)(),
...
// ../cli-error/src/cli-error-to-error.ts
init_esm_shims();
function cliErrorToError(cliError) {
  const cause = cliError.cause();
  const error = cause ? new Error(cliError.message, { cause }) : new Error(cliError.message);
  error.name = cliError.name;
  error.stack = cliError.stack;
  return error;
}
...
//# sourceMappingURL=chunk-IHFZTOBU.js.map