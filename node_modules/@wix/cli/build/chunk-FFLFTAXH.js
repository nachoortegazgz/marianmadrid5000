...
async function open2(testEndpoint, url) {
  await (0, import_http_client.createHttpClient)().post(testEndpoint, void 0, {
    params: {
      url
    }
  }).catch((error) => {
    if (import_http_client.HttpClient.isHttpError(error) && error.response?.data?.message) {
...
//# sourceMappingURL=chunk-FFLFTAXH.js.map