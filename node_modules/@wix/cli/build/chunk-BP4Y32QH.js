...
async function gitInit(cwd, branch = "main") {
...
async function gitHasRemote(cwd, remoteName) {
  try {
...
async function gitSetRemoteUrl(cwd, remoteName = "origin", remoteUrl) {
...
async function gitPush(cwd, remoteName = "origin", options = {}) {
...
async function gitGetUserInfo(cwd) {
...
//# sourceMappingURL=chunk-BP4Y32QH.js.map